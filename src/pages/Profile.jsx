    ...
    <>
      <section className='max-w-6xl mx-auto flex items-center justify-center flex-col'>
        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form>
            {/* Name Input */}
            <input type="text" value={name} id="name" disabled className='w-full mb-6 px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out'/>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm md:text-lg mb-6'>
              <p className='flex items-center'>Do you want to change your name? <span className='text-red-600 hover:text-red-700 transition ease-in-out duration-200 ml-1 cursor-pointer'>Edit</span>
              </p>
