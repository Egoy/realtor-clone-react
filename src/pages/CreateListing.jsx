    ...
    <main className='max-w-md px-2 mx-auto'>
        ...
        <form>
            ...
            <div className='flex'>
                ...
                <button type='button' id='type' value='rent' onClick={onChange} className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${type === 'rent' ? 'bg-white text-black' : 'bg-slate-600 text-white'}`}>
                    RENT
                </button>
            </div>
            ...
            <textarea type="text" value={address} id="address" onChange={onChange} placeholder='Address' required className='resize-none w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'/>
            ...
            <div className='flex items-center mt-6 mb-6'>
                <div>
                    ...
                    <div className='flex w-full justify-center space-x-6'>
                        <input type="number" id="regularPrice" value={regularPrice} onClick={onChange} min='50' max='400000000' required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
                        {type === 'rent' && (
                            <div> 
            ...
            {offer && (
                <div>
                    ...
                    <div className='flex w-full justify-center space-x-6'>
                        <input type="number" id="discountedPrice" value={discountedPrice} onClick={onChange} min='50' max='400000000' required={offer} className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
                        {type === 'rent' && (
                            <div> 
                                <p className='text-md w-full'>$ / Month</p>
                            </div>
            ...
            <div className="mb-6">
                ...
                <input type="file" id="images" onChange={onChange} accept=".jpg, .png, .jpeg" className='w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:border-slate-600'/>
            </div>
